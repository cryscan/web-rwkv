use crate::serde::de::enum_adjacently;
use crate::serde::de::enum_externally;
use crate::serde::de::enum_internally;
use crate::serde::de::enum_untagged;
use crate::serde::de::identifier;
use crate::serde::de::{field_i, FieldWithAliases, Parameters};
use crate::serde::fragment::{Expr, Fragment, Stmts};
use crate::serde::internals::ast::Variant;
