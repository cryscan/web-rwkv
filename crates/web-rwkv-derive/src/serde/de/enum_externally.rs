...
use crate::serde::de::enum_;
use crate::serde::de::struct_;
use crate::serde::de::tuple;
use crate::serde::de::{
...
use crate::serde::fragment::{Expr, Fragment, Match};
use crate::serde::internals::ast::{Field, Style, Variant};
use crate::serde::internals::attr;
use crate::serde::private;
...
fn deserialize_externally_tagged_variant(
    ...
    if let Some(path) = variant.attrs.deserialize_with() {
        ...
        return quote_block! {
            #wrapper
            _serde::#private::Result::map(
                _serde::de::VariantAccess::newtype_variant_seed::<#seed<#context, #wrapper_ty>>(__variant, #seed::new(self.context)), #unwrap_fn)
        };
    }
...
fn deserialize_externally_tagged_newtype_variant(
    ...
    match field.attrs.deserialize_with() {
        None => {
            ...
            quote_expr! {
                _serde::#private::Result::map(#func(__variant, #seed::new(self.context)), #this_value::#variant_ident)
            }
        }
        Some(path) => {
            ...
            quote_block! {
                #wrapper
                _serde::#private::Result::map(
                    _serde::de::VariantAccess::newtype_variant_seed::<#seed<#context, #wrapper_ty>>(__variant, #seed::new(self.context)),
